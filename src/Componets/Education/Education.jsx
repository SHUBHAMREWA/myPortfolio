...
return (
    ...
    >
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-text-dark dark:text-text-dark text-text-light">Education</h2>
      ...
      <div className="relative">
        {/* Vertical line */}
        <div className="absolute sm:left-1/2 left-0 transform -translate-x-1/2 sm:-translate-x-0 w-1 bg-primary-green h-full"></div>
        ...
        {education.map((education, index) => (
          ...
          >
            ...
            {/* Content Section */}
            <div
              className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl shadow-2xl border border-primary-green bg-card-light dark:bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(0,255,136,0.3)] ${
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    <h3 className="text-xl sm:text-2xl font-semibold text-text-light dark:text-text-dark">
                      {education.degree}
                    </h3>
